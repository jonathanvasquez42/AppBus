package cl.nombrempresa.appfun.InfoEmpresa.videoSeguridad;
 ...
 */
public class VideoSeguridadActivity extends AppCompatActivity {
    /**
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_video_seguridad);
        ...
        ruta = "http://"+puertaEnlace+"/musica/videoSeguridad/video.mp4"; // obtener login
        videoview = (VideoView) findViewById(R.id.VideoViewfinal);

        pDialog = new ProgressDialog(VideoSeguridadActivity.this);
        ...
        try{
            ...
            MediaController mediaController = new MediaController(VideoSeguridadActivity.this);
