...
public class categoriaFamilia extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container , Bundle savedInstanceState) {
        ...
        rootView = inflater.inflate(R.layout.fragment_categoriafamilia, container, false);

        recyclerView = (RecyclerView) rootView.findViewById(R.id.recyclerviewListadoFamilia);
        ...
        if(isOnline()){
            ...
            ObtenerRuta("/data/dataPelicula/dataFamilia.json");
