...
public class categoriaAnimacion extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container , Bundle savedInstanceState) {
        ...
        rootView = inflater.inflate(R.layout.fragment_categoriaanimacion, container, false);

        recyclerView = (RecyclerView) rootView.findViewById(R.id.recyclerviewListadoAnimacion);
        ...
        if(isOnline()){
            ...
            ObtenerRuta("/data/dataPelicula/dataAnimacion.json");
