...
public class categoriaClasico extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container , Bundle savedInstanceState) {
        ...
        rootView = inflater.inflate(R.layout.fragment_categoriaclasico, container, false);

        recyclerView = (RecyclerView) rootView.findViewById(R.id.recyclerviewListadoClasico);
        ...
        if(isOnline()){
            ...
            ObtenerRuta("/data/dataPelicula/dataClasico.json");
