...
public class categoriaDocumental extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container , Bundle savedInstanceState) {
        ...
        rootView = inflater.inflate(R.layout.fragment_categoriadocumental, container, false);

        recyclerView = (RecyclerView) rootView.findViewById(R.id.recyclerviewListadoDocumental);
        ...
        if(isOnline()){
            ...
            ObtenerRuta("/data/dataPelicula/dataDocumentales.json");
    ...
    public void ObtenerRuta(String data) {
        ...
        Log.e("data","http://"+puertaEnlace+""+data);
