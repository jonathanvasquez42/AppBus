...
public class categoriaTerror extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container , Bundle savedInstanceState) {
        ...
        rootView = inflater.inflate(R.layout.fragment_categoriaterror, container, false);

        recyclerView = (RecyclerView) rootView.findViewById(R.id.recyclerviewListadoTerror);
        ...
        if(isOnline()){
            ...
            ObtenerRuta("/data/dataPelicula/dataSuspenso.json");
