...
public class categoriaAccion extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container , Bundle savedInstanceState) {
        ...
        rootView = inflater.inflate(R.layout.fragment_categoriaaccion, container, false);

        recyclerView = (RecyclerView) rootView.findViewById(R.id.recyclerviewListadoAccion);
        ...
        if(isOnline()){
            ...
            ObtenerRuta("/data/dataPelicula/dataAventura.json");
    ...
    public void ObtenerRuta(String data) {
        ...
        Log.e("ruta salida","http://"+puertaEnlace+""+data);
