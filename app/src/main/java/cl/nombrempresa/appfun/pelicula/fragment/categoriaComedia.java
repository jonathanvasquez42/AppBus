...
public class categoriaComedia extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container , Bundle savedInstanceState) {
        ...
        rootView = inflater.inflate(R.layout.fragment_categoriacomedia, container, false);

        recyclerView = (RecyclerView) rootView.findViewById(R.id.recyclerviewListadoComedia);
        ...
        if(isOnline()){
            ...
            ObtenerRuta("/data/dataPelicula/dataComedia.json");
