...
public class categoriaPop extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container , Bundle savedInstanceState) {
        ...
        rootView = inflater.inflate(R.layout.fragment_musicapop, container, false);

        recyclerView = (RecyclerView) rootView.findViewById(R.id.recyclerviewListadoMusicaPop);
        ...
        if(isOnline()){
            ...
            ObtenerRuta("/data/dataMusica/dataArtista/dataPop.json");
    ...
    public void ObtenerRuta(String data) {
        ...
        categoriaPop.MyTask task = new categoriaPop.MyTask();
