...
public class categoriaChilena extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container , Bundle savedInstanceState) {
        ...
        rootView = inflater.inflate(R.layout.fragment_musicachilena, container, false);

        recyclerView = (RecyclerView) rootView.findViewById(R.id.recyclerviewListadoMusicaChilena);
        ...
        if(isOnline()){
            ...
            ObtenerRuta("/data/dataMusica/dataArtista/dataChilena.json");
    ...
    public void ObtenerRuta(String data) {
        ...
        categoriaChilena.MyTask task = new categoriaChilena.MyTask();
