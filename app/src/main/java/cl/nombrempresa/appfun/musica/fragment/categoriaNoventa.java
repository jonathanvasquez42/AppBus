...
public class categoriaNoventa extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container , Bundle savedInstanceState) {
        ...
        rootView = inflater.inflate(R.layout.fragment_musicanoventa, container, false);

        recyclerView = (RecyclerView) rootView.findViewById(R.id.recyclerviewListadoMusicaNoventa);
        ...
        if(isOnline()){
            ...
            ObtenerRuta("/data/dataMusica/dataArtista/dataNoventas.json");
    ...
    public void ObtenerRuta(String data) {
        ...
        categoriaNoventa.MyTask task = new categoriaNoventa.MyTask();
