...
public class categoriaRock extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container , Bundle savedInstanceState) {
        ...
        rootView = inflater.inflate(R.layout.fragment_musicarock, container, false);

        recyclerView = (RecyclerView) rootView.findViewById(R.id.recyclerviewListadoMusicarock);
        ...
        if(isOnline()){
            ...
            ObtenerRuta("/data/dataMusica/dataArtista/dataRock.json");
    ...
    public void ObtenerRuta(String data) {
        ...
        categoriaRock.MyTask task = new categoriaRock.MyTask();
