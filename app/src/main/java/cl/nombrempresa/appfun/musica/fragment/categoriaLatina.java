...
public class categoriaLatina extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container , Bundle savedInstanceState) {
        ...
        rootView = inflater.inflate(R.layout.fragment_musicalatina, container, false);

        recyclerView = (RecyclerView) rootView.findViewById(R.id.recyclerviewListadoMusicaLatina);
        ...
        if(isOnline()){
            ...
            ObtenerRuta("/data/dataMusica/dataArtista/dataLatina.json");
    ...
    public void ObtenerRuta(String data) {
        ...
        categoriaLatina.MyTask task = new categoriaLatina.MyTask();
